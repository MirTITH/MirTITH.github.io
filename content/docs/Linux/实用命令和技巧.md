...
或者使用这个脚本（原理相同）：[remote_wake_screen.sh](https://github.com/MirTITH/MirTITH.github.io/blob/main/content/docs/Linux/cachyos-安装/dotfiles/.local/bin/wake_screen.sh)
